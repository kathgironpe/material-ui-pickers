...
[![npm package](https://img.shields.io/npm/v/@kathgironpe/material-ui-pickers.svg)](https://www.npmjs.org/package/@kathgironpe/material-ui-pickers)
[![npm download](https://img.shields.io/npm/dm/@kathgironpe/material-ui-pickers.svg)](https://www.npmjs.org/package/@kathgironpe/material-ui-pickers)
...
[![Bundle Size](https://badgen.net/bundlephobia/minzip/@kathgironpe/material-ui-pickers)](https://bundlephobia.com/result?p=@kathgironpe/material-ui-pickers@latest)
...
```sh
// via npm
npm i @kathgironpe/material-ui-pickers

// via yarn
yarn add @kathgironpe/material-ui-pickers
```
...
import { MuiPickersUtilsProvider } from '@kathgironpe/material-ui-pickers';
