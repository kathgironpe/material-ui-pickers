...
const Releases: NextFC<ReleasesProps> = ({ tags }) => {
  ...
  return (
    <>
      <PageMeta
        title="Releases - @kathgironpe/material-ui-pickers"
        description="List of @kathgironpe/material-ui-pickers releases with a link to per-release documentation site."
      />
