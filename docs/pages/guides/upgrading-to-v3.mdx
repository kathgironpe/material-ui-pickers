...
Version `v3` for @kathgironpe/material-ui-pickers is coming with a whole bunch of breaking changes. This is a guide of how-to update :)
...
Please also note, that **v3** of `@kathgironpe/material-ui-pickers` relies on **v4** of `@material-ui/core`

```
npm i @kathgironpe/material-ui-pickers @material-ui/core@latest

yarn add @kathgironpe/material-ui-pickers @material-ui/core@latest
```
...
```diff
- import { InlineDatePicker } from '@kathgironpe/material-ui-pickers'
+ import { DatePicker } from '@kathgironpe/material-ui-pickers'
