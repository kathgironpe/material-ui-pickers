...
The following is a set of guidelines for contributing to @kathgironpe/material-ui-pickers. The purpose of these
...
1. Fork the @kathgironpe/material-ui-pickers repository on Github
2. Clone your fork to your local machine `git clone git@github.com:<yourname>/@kathgironpe/material-ui-pickers.git`
...
```sh
git remote add upstream git@github.com:mui-org/@kathgironpe/material-ui-pickers.git
git checkout next
